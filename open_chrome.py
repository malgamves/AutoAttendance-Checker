...
pos = pg.locateOnScreen(r'C:\Users\malga\Desktop\Projects\PyAutoGui\img\chrome.png')
...
pos = pg.locateOnScreen(r'C:\Users\malga\Desktop\Projects\PyAutoGui\img\sitetext.png')
...
pg.typewrite('http://180.211.119.163:8081/PUMIS/', interval = 0.5)
...
pg.typewrite('XXXXXXXX', interval = 0.5)

pg.hotkey('tab')

pg.typewrite('XXXX', interval = 0.5)
